...
📖 **Полное руководство по API**: `docs/API_GUIDE.md`  
📖 **Быстрый старт API**: `docs/API_QUICKSTART.md`
...
3. Выберите файл: `postman/GigaAM_API.postman_collection.json`
4. Настройте переменные окружения:
   - `base_url`: `http://localhost:8000` (или ваш URL)
   - `api_key`: ваш API ключ из `.api_keys`

**Документация:**
- **[POSTMAN_CHEATSHEET.md](docs/POSTMAN_CHEATSHEET.md)** - Быстрая шпаргалка
- **[POSTMAN_STEP_BY_STEP.md](docs/POSTMAN_STEP_BY_STEP.md)** - Пошаговая инструкция для новичков
- **[POSTMAN_GUIDE.md](docs/POSTMAN_GUIDE.md)** - Полное руководство
...
См. раздел "CLI (Командная строка" выше или полное руководство: `docs/CLI_GUIDE.md`

### API

См. раздел "REST API (Веб-сервис)" выше или полное руководство: `docs/API_GUIDE.md`
...
### 🚀 Быстрый старт
- **[CHEATSHEET.md](docs/CHEATSHEET.md)** - Шпаргалка (все команды)
- **[QUICK_START_GUIDE.md](docs/QUICK_START_GUIDE.md)** - Полный быстрый старт (CLI + API)
- **[API_QUICKSTART.md](docs/API_QUICKSTART.md)** - Быстрый старт API (5 минут)

### 📖 Руководства пользователя
- **[docs/CLI_GUIDE.md](docs/CLI_GUIDE.md)** - Полное руководство по CLI
- **[docs/API_GUIDE.md](docs/API_GUIDE.md)** - Полное руководство по API
- **[docs/API_SCHEMA.md](docs/API_SCHEMA.md)** - Схема API и эндпоинты

### 📮 Postman (Тестирование API)
- **[POSTMAN_CHEATSHEET.md](docs/POSTMAN_CHEATSHEET.md)** - Быстрая шпаргалка
- **[POSTMAN_STEP_BY_STEP.md](docs/POSTMAN_STEP_BY_STEP.md)** - Пошаговая инструкция
- **[POSTMAN_GUIDE.md](docs/POSTMAN_GUIDE.md)** - Полное руководство
...
### 🌐 Production
- **[DEPLOYMENT_GUIDE.md](docs/DEPLOYMENT_GUIDE.md)** - Развертывание и обслуживание
- **[deploy/README.md](deploy/README.md)** - Инструкции по развертыванию

### 📊 Обзор
- **[FEATURES_SUMMARY.md](docs/FEATURES_SUMMARY.md)** - Обзор всех возможностей

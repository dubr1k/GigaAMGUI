...
## 🎉 Что нового в v3.1 (февраль–март 2026)
...
- 📁 **Рекурсивное сканирование папок** — кнопка «Выбрать папку» и drag & drop теперь находят медиафайлы во всех вложенных подпапках, не только в корне
- 📱 **Поддержка 3GP** — транскрибация видео и аудио в формате .3gp (мобильные записи, голосовые заметки с Android/старых телефонов)

...
- Разработчикам [ONNX](https://github.com/onnx/onnx) и [ONNX Runtime](https://github.com/microsoft/onnxruntime) — за открытый формат моделей и кроссплатформенный движок инференса
